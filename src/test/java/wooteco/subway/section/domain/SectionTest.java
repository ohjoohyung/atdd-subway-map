...
class SectionTest {
    @DisplayName("상행역 또는 하행역이 입력되지 않았을 경우 예외")
    @Test
    public void whenNotContainAllStations() {
        assertThatThrownBy(() -> new Section(Arrays.asList(new Station(1L, "강남역")), new Distance(10)))
